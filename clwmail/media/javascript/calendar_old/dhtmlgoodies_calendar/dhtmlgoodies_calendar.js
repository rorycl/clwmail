...
var pathToImages = calimagespath;	// Relative to your HTML file
...
function writeCalendarContent()
{
	...
	calTable.setAttribute('id','caltbody');
...
function pickDate(e,inputDay)
{
	...
	if(parseInt(day)/1<10)day = '0' + day;
	if(returnFormat){
		...
		returnDateToMinute.value=minute;
	}
	closeCalendar();
...
function displayCalendarBox(yearInput,monthInput,dayInput,hourInput,minuteInput,buttonObj)
{
	...
	if (yearInput.value != "YYYY") {
		...
		currentMonth = current_time.getMonth()/1;
		currentYear = current_time.getFullYear();
		currentHour = current_time.getHours();
		if (currentHour <10)currentHour = '0'+currentHour;
		inputHour = currentHour/1;

		currentMinute = current_time.getMinutes();
		if (currentMinute <10)currentMinute = '0'+currentMinute;
		
		inputMinute = currentMinute/1;

		inputYear = yearInput.value;
		inputMonth = current_time.getMonth()/1;
		inputDay = current_time.getDay()/1;
	}
